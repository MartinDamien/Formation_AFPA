...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=641776437ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Tables récentes" class="drop_button btn">Récentes</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=table_name&table=categorie">`table_name`.`categorie`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=table_name&table=produit">`table_name`.`produit`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=table_name&table=myguests">`table_name`.`myguests`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=table_name&table=petite_tablette">`table_name`.`petite_tablette`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=table_name&table=tablette">`table_name`.`tablette`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=table_name&table=table_name">`table_name`.`table_name`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=table_name&table=produit_1">`table_name`.`produit_1`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=csv_db+11&table=produits">`csv_db 11`.`produits`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=2_deuxieme&table=user">`2_deuxieme`.`user`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=2_deuxieme&table=role">`2_deuxieme`.`role`</a></li></ul></div><div class="drop_list"><button title="Tables préférées" class="drop_button btn">Préférées</button><ul id="pma_favorite_list"><li class="warp_link">Pas de tables préférées.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  <ul>
    <li class="first new_database italics"><div class='block'><i class='first'></i></div><div class="block second"><a href='index.php?route=/server/databases&server=1'><img src="themes/dot.gif" title="" alt="" class="icon ic_b_newdb"></a></div><a class='hover_show_full' href='index.php?route=/server/databases&server=1' title='Nouvelle base de données'>Nouvelle base de données</a><div class="clearfloat"></div></li><li class="database"><div class='block'><i></i><b></b><a class="expander" href='#'><span class="hide paths_nav" data-apath="cm9vdA==.MV9wcmVtaWVyZQ==" data-vpath="cm9vdA==.MV9wcmVtaWVyZQ==" data-pos="0"></span><img src="themes/dot.gif" title="Développer/Réduire" alt="Développer/Réduire" class="icon ic_b_plus"></a></div><div class="block second"><a href='index.php?route=/database/operations&amp;server=1&amp;db=1_premiere&amp;'><img src="themes/dot.gif" title="Opérations sur base de données" alt="Opérations sur base de données" class="icon ic_s_db"></a></div><a class='hover_show_full' href='index.php?route=/database/structure&server=1&amp;db=1_premiere' title='Structure'>1_premiere</a><div class="clearfloat"></div></li><li class="database"><div class='block'><i></i><b></b><a class="expander" href='#'><span class="hide paths_nav" data-apath="cm9vdA==.Ml9kZXV4aWVtZQ==" data-vpath="cm9vdA==.Ml9kZXV4aWVtZQ==" data-pos="0"></span><img src="themes/dot.gif" title="Développer/Réduire" alt="Développer/Réduire" class="icon ic_b_plus"></a></div><div class="block second"><a href='index.php?route=/database/operations&amp;server=1&amp;db=2_deuxieme&amp;'><img src="themes/dot.gif" title="Opérations sur base de données" alt="Opérations sur base de données" class="icon ic_s_db"></a></div><a class='hover_show_full' href='index.php?route=/database/structure&server=1&amp;db=2_deuxieme' title='Structure'>2_deuxieme</a><div class="clearfloat"></div></li><li class="database"><div class='block'><i></i><b></b><a class="expander" href='#'><span class="hide paths_nav" data-apath="cm9vdA==.YsOidGltZW50" data-vpath="cm9vdA==.YsOidGltZW50" data-pos="0"></span><img src="themes/dot.gif" title="Développer/Réduire" alt="Développer/Réduire" class="icon ic_b_plus"></a></div><div class="block second"><a href='index.php?route=/database/operations&amp;server=1&amp;db=b%C3%A2timent&amp;'><img src="themes/dot.gif" title="Opérations sur base de données" alt="Opérations sur base de données" class="icon ic_s_db"></a></div><a class='hover_show_full' href='index.php?route=/database/structure&server=1&amp;db=b%C3%A2timent' title='Structure'>bâtiment</a><div class="clearfloat"></div></li><li class="database"><div class='block'><i></i><b></b><a class="expander" href='#'><span class="hide paths_nav" data-apath="cm9vdA==.aW5mb3JtYXRpb25fc2NoZW1h" data-vpath="cm9vdA==.aW5mb3JtYXRpb25fc2NoZW1h" data-pos="0"></span><img src="themes/dot.gif" title="Développer/Réduire" alt="Développer/Réduire" class="icon ic_b_plus"></a></div><div class="block second"><a href='index.php?route=/database/operations&amp;server=1&amp;db=information_schema&amp;'><img src="themes/dot.gif" title="Opérations sur base de données" alt="Opérations sur base de données" class="icon ic_s_db"></a></div><a class='hover_show_full' href='index.php?route=/database/structure&server=1&amp;db=information_schema' title='Structure'>information_schema</a><div class="clearfloat"></div></li><li class="database"><div class='block'><i></i><b></b><a class="expander" href='#'><span class="hide paths_nav" data-apath="cm9vdA==.bWFnYXNpbg==" data-vpath="cm9vdA==.bWFnYXNpbg==" data-pos="0"></span><img src="themes/dot.gif" title="Développer/Réduire" alt="Développer/Réduire" class="icon ic_b_plus"></a></div><div class="block second"><a href='index.php?route=/database/operations&amp;server=1&amp;db=magasin&amp;'><img src="themes/dot.gif" title="Opérations sur base de données" alt="Opérations sur base de données" class="icon ic_s_db"></a></div><a class='hover_show_full' href='index.php?route=/database/structure&server=1&amp;db=magasin' title='Structure'>magasin</a><div class="clearfloat"></div></li><li class="database"><div class='block'><i></i><b></b><a class="expander" href='#'><span class="hide paths_nav" data-apath="cm9vdA==.bXlzcWw=" data-vpath="cm9vdA==.bXlzcWw=" data-pos="0"></span><img src="themes/dot.gif" title="Développer/Réduire" alt="Développer/Réduire" class="icon ic_b_plus"></a></div><div class="block second"><a href='index.php?route=/database/operations&amp;server=1&amp;db=mysql&amp;'><img src="themes/dot.gif" title="Opérations sur base de données" alt="Opérations sur base de données" class="icon ic_s_db"></a></div><a class='hover_show_full' href='index.php?route=/database/structure&server=1&amp;db=mysql' title='Structure'>mysql</a><div class="clearfloat"></div></li><li class="database"><div class='block'><i></i><b></b><a class="expander" href='#'><span class="hide paths_nav" data-apath="cm9vdA==.bmF0dXJl" data-vpath="cm9vdA==.bmF0dXJl" data-pos="0"></span><img src="themes/dot.gif" title="Développer/Réduire" alt="Développer/Réduire" class="icon ic_b_plus"></a></div><div class="block second"><a href='index.php?route=/database/operations&amp;server=1&amp;db=nature&amp;'><img src="themes/dot.gif" title="Opérations sur base de données" alt="Opérations sur base de données" class="icon ic_s_db"></a></div><a class='hover_show_full' href='index.php?route=/database/structure&server=1&amp;db=nature' title='Structure'>nature</a><div class="clearfloat"></div></li><li class="database"><div class='block'><i></i><b></b><a class="expander" href='#'><span class="hide paths_nav" data-apath="cm9vdA==.cGVyZm9ybWFuY2Vfc2NoZW1h" data-vpath="cm9vdA==.cGVyZm9ybWFuY2Vfc2NoZW1h" data-pos="0"></span><img src="themes/dot.gif" title="Développer/Réduire" alt="Développer/Réduire" class="icon ic_b_plus"></a></div><div class="block second"><a href='index.php?route=/database/operations&amp;server=1&amp;db=performance_schema&amp;'><img src="themes/dot.gif" title="Opérations sur base de données" alt="Opérations sur base de données" class="icon ic_s_db"></a></div><a class='hover_show_full' href='index.php?route=/database/structure&server=1&amp;db=performance_schema' title='Structure'>performance_schema</a><div class="clearfloat"></div></li><li class="database"><div class='block'><i></i><b></b><a class="expander" href='#'><span class="hide paths_nav" data-apath="cm9vdA==.cGhwbXlhZG1pbg==" data-vpath="cm9vdA==.cGhwbXlhZG1pbg==" data-pos="0"></span><img src="themes/dot.gif" title="Développer/Réduire" alt="Développer/Réduire" class="icon ic_b_plus"></a></div><div class="block second"><a href='index.php?route=/database/operations&amp;server=1&amp;db=phpmyadmin&amp;'><img src="themes/dot.gif" title="Opérations sur base de données" alt="Opérations sur base de données" class="icon ic_s_db"></a></div><a class='hover_show_full' href='index.php?route=/database/structure&server=1&amp;db=phpmyadmin' title='Structure'>phpmyadmin</a><div class="clearfloat"></div></li><li class="last database"><div class='block'><i></i><a class="expander" href='#'><span class="hide paths_nav" data-apath="cm9vdA==.dGFibGVfbmFtZQ==" data-vpath="cm9vdA==.dGFibGVfbmFtZQ==" data-pos="0"></span><img src="themes/dot.gif" title="Développer/Réduire" alt="Développer/Réduire" class="icon ic_b_plus"></a></div><div class="block second"><a href='index.php?route=/database/operations&amp;server=1&amp;db=table_name&amp;'><img src="themes/dot.gif" title="Opérations sur base de données" alt="Opérations sur base de données" class="icon ic_s_db"></a></div><a class='hover_show_full' href='index.php?route=/database/structure&server=1&amp;db=table_name' title='Structure'>table_name</a><div class="clearfloat"></div></li>
  </ul>
</div>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="7d5e6d2c2e6d5a5324307c4472552950">
  ...
  <div id="pma_console_container">
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Faire Entrée pour exécuter la requête                    </span>
                            ...
                            targetdb="table_name" targettable="">
            ...
            Daté du
                            ...
                            <span class="query">CREATE TABLE IF NOT EXISTS petite_tablette (info1 INT, info2 VARCHAR(50));</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="table_name" targettable="petite_tablette">
                            <div class="action_content">
                    <span class="action collapse">
            Réduire
                    </span>
            ...
            Daté du
                            ...
                            <span class="query">SELECT * FROM `petite_tablette`</span>
                        </div>
                                            <div class="message history collapsed hide"
                            targetdb="table_name" targettable="petite_tablette">
                            <div class="action_content">
            ...
            Daté du
                            ...
                            <span class="query">INSERT INTO `petite_tablette` (`info1`, `info2`) VALUES (&#039;11&#039;, &#039;zezg&#039;);</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="table_name" targettable="petite_tablette">
                            <div class="action_content">
            ...
            Daté du
                            ...
                            <span class="query">SELECT * FROM `petite_tablette`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="table_name" targettable="myguests">
                            <div class="action_content">
                    <span class="action collapse">
            Réduire
                    </span>
            ...
            Daté du
                            ...
                            <span class="query">SELECT * FROM `myguests`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="table_name" targettable="produit">
                            <div class="action_content">
                    <span class="action collapse">
            Réduire
                    </span>
            ...
            Daté du
                            ...
                            <span class="query">CREATE TABLE IF NOT EXISTS categorie(
    categorie INT AUTO_INCREMENT,
    ...
    PRIMARY KEY(categorie)
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="table_name" targettable="categorie">
                            <div class="action_content">
                    <span class="action collapse">
            Réduire
                    </span>
    ...
    PRIMARY KEY(categorie)
            ...
            Daté du
                            ...
                            <span class="query">INSERT INTO `categorie` (`categorie`, `nom_produit`, `description`, `PHT`, `TVA`, `photo`) VALUES (&#039;course&#039;, &#039;velo1&#039;, &#039;Vélo 12\&#039;\&#039; Pat\&#039;Patrouille équipé de 2 freins, Plaque avant décorative, Garde Boue, Carter, Stabilisateurs amovibles + Bidon&#039;, &#039;14.45&#039;, &#039;20&#039;, &#039;velo1.jpg&#039;);</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="table_name" targettable="categorie">
                            <div class="action_content">
