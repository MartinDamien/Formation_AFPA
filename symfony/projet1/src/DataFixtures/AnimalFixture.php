...
class AnimalFixture extends Fixture
{
    public function load(ObjectManager $manager): void
    {
        ...
        $a1 = new Animal();
        $a1->setNom('Cheval')->addContinent($c1)->addContinent($c2)->setEspece($e1)->setPoids(100)
        ...
        $a2 = new Animal();
        $a2->setNom('Chien')->addContinent($c1)->addContinent($c3)->addContinent($c4)->setEspece($e1)->setPoids(40)
        ...
        $a3 = new Animal();
        $a3->setNom('Chat')->addContinent($c1)->addContinent($c4)->setEspece($e1)->setPoids(5)
        ...
        $a4 = new Animal();
        $a4->setNom('dauphin')->addContinent($c1)->addContinent($c3)->addContinent($c4)->setEspece($e1)->setPoids(10)
        ...
        $a5 = new Animal();
        $a5->setNom('Lapin')->addContinent($c1)->addContinent($c2)->setEspece($e1)->setPoids(5)
        ->setImage("lapin.png")
        ...
        $a6 = new Animal();
        $a6->setNom('Oiseau')->addContinent($c1)->addContinent($c3)->setEspece($e2)->setPoids(3)
        ->setImage("oiseau.png")
